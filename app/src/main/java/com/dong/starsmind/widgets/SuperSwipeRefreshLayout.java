...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private static final int DEFAULT_CIRCLE_TARGET = 80;//下拉时的计算高度
        ...
        if (autoCheck) {
            if (Build.VERSION.SDK_INT < 14) {
                ...
                if (mTarget instanceof RecyclerView) {
                    isChildScrollToTop = !(((RecyclerView) mTarget).computeVerticalScrollOffset() > 0);
