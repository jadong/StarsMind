package com.dong.starsmind.read.adapter;
...
import com.dong.starsmind.read.viewholder.BookViewHolder;
...
public class BookshelfAdapter extends RecyclerViewAdapter<Book> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = getLayoutInflater().inflate(R.layout.layout_book_item, parent, false);
